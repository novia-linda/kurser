# Samarbete i Microsoft 365 Copilot
...
| `samarbete-i-microsoft-365-copilot-moodle.html` | Samma kurs, att klistra in i Moodles redigerare. |
...
1. Öppna `samarbete-i-microsoft-365-copilot-moodle.html` i en textredigerare och kopiera hela innehållet.
